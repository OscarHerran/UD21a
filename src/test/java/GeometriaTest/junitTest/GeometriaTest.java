...
import GeometriaTest.junitTest.GeometriaApp;
import GeometriaTest.junitTest.Geometria;
...
public class GeometriaTest 
{
    ...
    public void testareacuadrado() {
    	int result = g.areacuadrado(3);
    	int resultEsperado = 9;
